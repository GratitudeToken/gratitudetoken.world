...
<img class="fullWidth" style="margin-top: 0.32em" src="/white-paper/img/Buckminster-Fuller-Tensegrity-Sphere.jpg" loading="lazy" />
    ...
    The WWW is founded from greed and it ignorantly sustains the 6<sup>th</sup> great extinction event. It is time for our species to evolve to a Biosphere Web that connects everything from gratitude to ∞ infinity.
...
<h2 class="heading">Summary</h2>
    ...
    The entire system exists only to slowly indoctrinate us with a singular goal: Struggle hard to get more units of currency or other symbols and fall into the trap of thinking that if we had more money, we could have everything we ever wanted (consumerism).
        ...
        <page class="page">    <h3 class="heading">GRATITUDE 感謝</h3> -  In this part, we talk about the meaning of gratitude and offer an introduction to our ambitious project.
    ...
    Our “21st century normal - a fibrillating anxious state from an overactive ego, stemming from a misfiring default mode network which is the auto-biographical mind […]”.
    ...
    <h3 class="heading">GENESIS 元</h3> - means beginning. In our case, the beginning of the shift to the Biosphere Consciousness Digital Internet.
    Inspired from the infinite torus, the name and logo represent the umbrella of 8 chosen initiatives that will begin and lead the change towards the new Biospheric Internet era. Here we elaborate on our practical vision and the specifics of our ambitious plans.
        ...
        <page class="page">    <h3 class="heading">SHIELD 盾</h3> - In this part, we describe our powerful open-source decision-making tool with <strong>NPPoS</strong> (Non-Profit Proof of Stake) membership.
...
<h1 class="heading fullWidth"><img src="/svgs/gratitude-token-logo-white.svg" alt="value" loading="lazy"/>VALUE 価値</h1>
...
<img class="fullWidth stickBottom" src="/white-paper/img/connected-human-beings-value-consciousness.jpg" alt="connected human beings value consciousness" loading="lazy"/>
    ...
    To quote Charlie Chaplin from “The Great Dictator”:
    <i><b>“Do not despair, the misery that is now upon us is but the passing of greed - the bitterness of men who fear the way of human progress.</b>”</i>
...
<img style="top: 69%" class="fullWidth" src="/white-paper/img/gratitude-token-world.jpg" alt="gratitude token world logo" loading="lazy"/>
    ...
    It's over… let go of that character! Let go of the voice saying: “I'm just surviving, just too poor, just getting by, just can't decide, just can't do things right, just don't know enough, am too old for learning, am not smart enough, am not beautiful enough, am too weak”.
...
<img class="fullWidth stickBottom" src="/white-paper/img/game-over.jpg" alt="If we stand up, their little game is over." loading="lazy"/>
    ...
    So … we find ourselves in a world where people work for money, not for each other. Living on a “Money Planet” as it were. But who made this system? Did we humans make it so unfair?
...
<img style="width: 50% !important; margin: 1em auto" class="imgCenter" src="/white-paper/img/Amschel_Mayer_Rothschild.jpg" alt="Amschel Mayer Rotschild" loading="lazy"/>    <i><b>“GIVE me control of a nation's money supply and I care not who makes its laws.” So said Mayer Amschel Rothschild, founder of the Rothschild banking dynasty.</b></i>
        </page>
...
<h3 class="heading">Being unexperienced</h3>
    ...
    Big players also known as “whales” also make tons of money by manipulating the markets with unbelievable amounts of liquidity at their disposal. In crypto markets, this is seen as crazy volatility by most people,
        </page>
...
<img class="fullWidth" style="margin-top: -0.69em" src="/white-paper/img/global-inflation-since-1920.jpg" alt="global inflation since 1920" loading="lazy"/>
    ...
    In essence, after many decades of resistance by the founding fathers of America (fair to say of which many were also criminals), a secretive elite group has succeeded through assassinations, manipulation, and bribes to obtain the right to “print” money from nothing in the year of 1913 when the private Federal Reserve company was founded.
        </page>
        <page class="page">    They could from that point in time print money and loan the printed money to the government and banks. Money that is not backed by anything, no resources, no services, no information, nothing but our ignorance and fears. That is when they created the “monopoly game” and started siphoning away power from all the people.
    ...
    It's printing more money and dumping it into the “economy”.
    ...
    Next, having an approved loan, the account that you have with the bank simply magically appears to now have more valueless digital numbers. So, at the stroke of a few keys, they (the bank employees) create “legal” units of currency that did not exist before that approval.
        </page>
...
<strong class="centered">1990</strong>
    ...
    PayPal would become the world's biggest P2P (Peer to Peer) money transfer service which also offered a bridge for banks. Because of this bridge, PayPal was “allowed” to grow.
        </page>
    ...
    In this type of system, those who exchange their fiat money or other cryptocurrencies into the new Token or Coin early on are called “early adopters” - they have patience and are rewarded long-term by the increase in demand for that certain symbol.
...
<img class="imgCenter" style="width: 36% !important" src="/white-paper/img/gratitude-nodes-sphere.jpg" alt="gratitude token nodes sphere" loading="lazy"/>
    ...
    The relationship between an object and an abstraction or representation, no matter how complex, can be described by quoting the legendary Alan Watts: “<b>The menu is not the meal</b>”. We should really understand this relationship because it implies the question: <b>What is real?</b>
    To give one answer to this question, I will quote from Mr. Robot Netflix series (Season 1, Episode 10):
    <i>“We live in a world built on fantasy.
    ...
    We live in a kingdom of bullshit. A kingdom you lived in for far too long.”</i>
        </page>
...
<h2 class="heading">Consensus</h2>
    ...
    <i>“Nowadays people know the price of everything and the value of nothing.”</i> - Oscar Wilde

<h1 class="heading fullWidth"><img src="/svgs/gratitude-token-logo-white.svg" alt="gratitude token logo" loading="lazy"/>DO 贈る</h1>
<img class="fullWidth stickBottom" src="/white-paper/img/global-action-youth.jpg" alt="global action youth" loading="lazy"/>
        </page>
        <page class="page">    <b>DO 贈る</b> - Stands for action, movement, creativity, service, energy.
...
<h2 class="heading">Consumption</h2>
    ...
    Creation does not destroy, it only transforms. As we know from physics, nothing can be destroyed, it can only be transformed.
        ...
        <page class="page">    <b>The problem with our species was never consumption, it was always the fact that we keep throwing away what we transform</b> as if there is such a thing as “away” on a finite planet. We were never taught to ask ourselves: <b>Where do we put the things we no longer want or need?</b>
...
<h1 class="heading fullWidth"><img src="/svgs/gratitude-token-logo-white.svg" alt="gratitude token logo" loading="lazy"/>GRATITUDE 感謝</h1>
<img class="fullWidth stickBottom" src="/white-paper/img/gratitude-gift.jpg" alt="gratitude gift giving charity" loading="lazy"/>
        </page>
        <page class="page"><b>GRATITUDE 感謝</b> – Is truly the most amazing discovery you can make in your entire life.
    It's so easy to miss this life changing state of heart and mind in our 21st century normal.
    “21st century normal - a fibrillating anxious state from an overactive ego, stemming from a misfiring default mode network which is the auto-biographical mind […]” – Jason Silva
...
<h2 class="heading">Desires and Discipline</h2>
    ...
    <i><b>“The mind is a good servant, but a bad master.”</b></i> – Alan Watts
    ...
    “Clinical trials indicate that the practice of gratitude can have dramatic and lasting effects in a person's life,” said Robert A. Emmons, professor of</i>
        </page>
        <page class="page"><i>psychology at UC Davis. “It can lower blood pressure, improve immune function and facilitate more efficient sleep.”
    ...
    “Some people may not be grateful by nature, but it is a habit you can get</i>
        </page>
        <page class="page"><i>accustomed to,” said Dr. Norman Rosenthal, a psychiatrist and author of “Winter Blues.”
    ...
    “Some people say they don't have anything to be grateful for,” Mills said. “If you take such a person to find one little thing to be grateful for and focus on that, you find over time that the feeling of gratitude can transform the way they see their lives.”</i><div style="text-align: right;">Source: <a href="https://www.today.com/health/be-thankful-science-says-gratitude-good-your-health-t58256" target="_blank">Today.com</a></div>
...
<h1 class="heading fullWidth"><img src="/svgs/gratitude-token-logo-white.svg" alt="gratitude token world logo" loading="lazy"/>TECHNOLOGY 技術</h1>
...
<h2 class="heading">Defining the BiiP standard</h2>
    ...
    These 2 algorithms or protocols (PoW and PoS) are the main “Consensus Protocols” that were used for cryptocurrency so far.
...
<div class="fullWidth"><iframe src="https://www.youtube-nocookie.com/embed/B8ofWFx525s" title="Beware online 'filter bubbles' | Eli Pariser" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
    ...
    Do you see the problem? The 🔺 Surveillance Capitalism Pyramid Model of Digital Human Interaction is the problem.
...
<h2 class="heading">The opportunity</h2>
    Essentially, we are heading towards the beginning of a 🌏 Worldwide Digital Revolution which is happening ⏰ Right Now. Approximately 10 corporations own all of the internet and mass media. Together we will end this 🔺 Pyramid Scheme that has been going on for far too long.
        </page>
...
<h2 class="heading">But what if we can choose better?</h2>
    We live in a world of creation and consumption where we can all be both creators and consumers, but our 🌍 collective biospheric wisdom and power come from sharing, not hoarding.
...
<h2 class="heading">Let's give Gratitude a chance</h2>
    ...
    We regard it as 🌍 real-time global gratitude energy which should be equally and uniformly flowing, nourishing us all to our highest human potential. Currently, it is being siphoned (for the lack of a better word) by psychopaths or sociopaths and the whole world is suffering because of them. <b>It's our turn to grow and prosper!</b> Their game will soon be over.
...
<h2 class="heading">Adaptive IDO (Initial DEX Offering)</h2>
    ...
    The number 12 billion was calculated on the basis of an <b>11 billion</b> people Max Human Population, a maximum theoretically possible on our current 🌏 Earth - according to the best current Earth math and statistics, as you can see in this video: <a href="https://www.youtube.com/watch?v=2LyzBoHo5EI" target="_blank">Why the world population won't exceed 11 billion</a>
...
<h1 class="heading fullWidth"><img src="/svgs/gratitude-token-logo-white.svg" alt="gratitude token world logo" loading="lazy"/>GENESIS 元</h1>
...
<img class="fullWidth" src="/white-paper/img/genesis.jpg" alt="genesis logo" loading="lazy"/>
    ...
    <b>GENESIS 元</b> - Means beginning. In our case, the beginning of the shift to the Biospheric Consciousness Digital Internet.
...
<h3 class="heading">A biosphere media, not "social media"</h3>
    ...
    You probably experienced by now that the “social” part of social media is not really social. After spending time there, did it really make you feel like you socialized? Did you make new authentic connections? Did you become a better human persona? Probably not.
<h3 class="heading">The echo chamber effect</h3>
    ...
    Truth be told, studies have shown that most people feel lonely, anxious, angry and depressed while and after “socializing” in today's social media.
    We probably all wondered at one point why a better platform isn't taking over Facebook yet. Censorship is now at a nazi level there, information feeds are manipulated into a personal information prison (exactly as they want it) – a bubble.
    They spy on us, they treat us like cattle, and we do what? We keep using their dis-service.
    But consciousness is expanding, slowly but surely we realize that maybe all we have to DO is to imagine a better digital media, a Biosphere Media if you will and exclude the word “social” from a digital platform that is never going to replace real human socialization.
...
<div class="fullWidth stickBottom"><iframe src="https://www.youtube-nocookie.com/embed/-Ht4qiDRZE8" title="Massive-scale online collaboration | Luis von Ahn" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
    ...
    If Facebook and other social media platforms/apps would not be running ads, they would go bankrupt before you can say “Website under maintenance”. If these businesses and in general, if people would have any better option other than ads to get exposure, they would go for it. Giants fall in time too, just like the cassette and CD industry ended when the mp3 technology took off.
...
<h2 class="heading">Beyond advertising</h2>
    ...
    <b>• As a Consumer</b> you can choose an automatic amount given away for every interaction with content created by others, or manually send tokens in one click/touch.
    <b>• As a Creator</b> you can choose an automatic amount of GRAT to give to users sharing your content with others, the more generous, the more exposure you get.
...
<h3 class="heading">The GRAT operational model for biosphere.media</h3>
    ...
    Our exposure/reward model is based on a digital “word of mouth effect” achieved naturally and organically, without bothering to create and manage any ad campaigns that most of the time fail to serve the clients to get more value from their business/idea. <b>You are free to focus on creation!</b>
    By using our model for a biosphere media platform/app instead of the old “ads monetization” model, the interaction with the content created by the users will evolve organically and the value created and shared by the entire network will increase and flow organically across all dimensions of human activity associated with or invested in such a network.
...
<h2 class="heading">The end of surveillance capitalism</h2>
    ...
    Maybe we can change our direction and maybe… just maybe, we can go towards what Jason Silva explained in this video on the next page in symbiosis, not as slaves: <a href="https://www.youtube.com/watch?v=cITA2ysR4z0" target="_blank">The Six Epochs of Evolution</a>   
        </page>
...
<div class="fullWidth stickBottom"><iframe src="https://www.youtube-nocookie.com/embed/5dZ_lvDgevk" title="In the Age of AI (full film) | FRONTLINE" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
    ...
    You may have noticed that you can't post anything anymore that has the slightest nuance of reference to subjects they think are “Not OK to post” or that have the slightest feeling of revolt against the system. You may have noticed the reason they invoke for this is that we didn't follow their “Community Guidelines” which are not created and vetted by any community, it's written by them alone.
        </page>
